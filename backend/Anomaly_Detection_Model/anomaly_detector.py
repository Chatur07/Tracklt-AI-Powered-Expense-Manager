 # -----------------BACKEND SERVER TO DETETCT ANOMALY FOR TRACKIT-------------------------
...
modelfile= open("./backend/Anomaly_Detection_Model/Isolation_Forest/anomaly_detection_model.pkl",'rb')
model=pickle.load(modelfile)
encoderfile= open("./backend/Anomaly_Detection_Model/encoder.pkl", "rb")
ohe=pickle.load(encoderfile)
scalerfile=open("./backend/Anomaly_Detection_Model/scaler.pkl", "rb")
